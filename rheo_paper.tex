...
\begin{itemize}
  ...
  \item In our case study the internal friction term in MC model has a relatively small impact on the dynamics of the flow. Neglecting the term may be a meaningful choice when workload reduction is required.
\end{itemize}
