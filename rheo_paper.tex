...
\begin{figure}[H]
    ...
    \caption{Inclined plane setup. Contours of $h = 1.0$ mm at last simulated snapshot ($t = 1.5$ sec) for simulated flows with \underline{\texttt{minimum runout}} obtained from \emph{\textbf{min volume -- max resistance}}, and \underline{\texttt{maximum runout}} obtained from \emph{\textbf{max volume -- min resistance}}. {\color{blue} \textbf{---}} : MC, {\color{red} \textbf{---}} : PF, \textbf{---} : VS.}\label{fig:Ramp-MaxMinRunouts}
\end{figure}
...
\newpage
\subsection{Hidden quantities}\label{Hq1}
Forces analyzed have been classified according to the terms of the momentum equation in \ref{eq:D_A}. Moreover, the forces terms in $S_x$ have been additionally classified, accordingly to equations \ref{S_terms_MC}, \ref{eq:S_terms_PF}, \ref{eq:S_terms_VS}, describing the three rheology models considered in this study.

This is a summary of the force terms, and this notation will be used in the following (see also Section \ref{statF}).
...
\subsection{Observable outputs} \label{Obs2}
\subsubsection{Flow Height, local measurements}
\begin{figure}[H]
         \centering
        \includegraphics[width=1\textwidth]{MC&VS_51/Height_MC.png}
        \caption{MC model, records of average flow height, $h(L,t)$, at 51 spatial locations of interest.}
        \label{fig:BAF-H-MC}
\end{figure}
...
\begin{figure}[H]
        ...
        \caption{VS model, records of average flow height, $h(L,t)$, at 51 spatial locations of interest.}
        \label{fig:BAF-H-VS}
\end{figure}
...
\begin{figure}[H]
        ...
        \caption{MC model, records of average flow speed, $\vert\underline{u}\vert(L,t)$, at 51 spatial locations of interest.}
        \label{fig:BAF-V-MC}
\end{figure}
...
\begin{figure}[H]
        ...
        \caption{VS model, records of average flow speed, $\vert\underline{u}\vert(L,t)$, at 51 spatial locations of interest.}
        \label{fig:BAF-V-VS}
\end{figure}
...
\begin{figure}[H]
        ...
        \caption{MC model, records of average Froude Number at 51 spatial locations of interest.}
        \label{fig:BAF-Fr-MC}
\end{figure}
...
\begin{figure}[H]
        ...
        \caption{VS models, records of average Froude Number at 51 spatial locations of interest.}
        \label{fig:BAF-Fr-VS}
\end{figure}
...
\subsection{Hidden quantities}\label{Hq2}
