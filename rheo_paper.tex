...
\begin{figure}[H]
         \centering
        \includegraphics[width=1\textwidth]{Figures/MC.jpg}
        \caption{Comparison between \emph{Max Flow Height Record} and \emph{Max Velocity Record} maps of simulated flow, assuming Mohr-Coulomb rheology. Extreme cases producing maximum and minimum runout, i.e. (a),(b) \emph{\textbf{max volume -- min resistance}} and (c),(d) \emph{\textbf{min volume -- max resistance}}. Parameters values and input options are also reported.}
        \label{Colima-MaxMinExtentsMC}
\end{figure}
...
\begin{figure}[H]
         \centering
        \includegraphics[width=1\textwidth]{Figures/PF.jpg}
        \caption{Comparison between \emph{Max Flow Height Record} and \emph{Max Velocity Record} maps of simulated flow, assuming Pouliquen-Forterre rheology. Extreme cases producing maximum and minimum runout, i.e. (a),(b) \emph{\textbf{max volume -- min resistance}} and (c),(d) \emph{\textbf{min volume -- max resistance}}. Parameters values and input options are also reported.}
        \label{Colima-MaxMinExtentsPF}
\end{figure}
...
\begin{figure}[H]
         \centering
        \includegraphics[width=1\textwidth]{Figures/VS.jpg}
        \caption{Comparison between \emph{Max Flow Height Record} and \emph{Max Velocity Record} maps of simulated flow, assuming Voellmy-Salm rheology. Extreme cases producing maximum and minimum runout, i.e. (a),(b) \emph{\textbf{max volume -- min resistance}} and (c),(d) \emph{\textbf{min volume -- max resistance}}. Parameters values and input options are also reported.}
        \label{Colima-MaxMinExtentsVS}
\end{figure}
