...
\begin{figure}[H]
        ...
        \caption{Records of dominance probabilities of \textbf{RHS} forces, in the slope direction, at four spatial locations of interest. Different rheology models are displayed with different colors. No-flow probability is also displayed with a green dashed line.}
        \label{fig:Ramp-Pr_x}
\end{figure}
