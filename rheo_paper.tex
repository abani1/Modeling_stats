...
%The simulation algorithms can be represented as in Figure \ref{diag}:
%\begin{figure}[H]
%\centerline{\includegraphics[width=0.85\textwidth]{modelproc.png}}
%\centering
...
\begin{figure}[H]
         \centering
        \includegraphics[width=0.95\textwidth]{figures/Colima/SensitivityFigure.jpg}
