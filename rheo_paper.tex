...
\begin{figure}[H]
    ...
    \centering
    \caption{Volc{\'a}n de Colima (M{\'e}xico) overview, including 51 numbered local sample sites (stars) and four labeled major ravines channeling the flow. Pile location is marked by a blue dot. Reported coordinates are in UTM zone 13N. Digital elevation map and regional geology map are also displayed. Six points that will be adopted as preferred locations are highlighted in yellow.}
...
\subsection{Contribution coefficients}

\section{QoIs and Data Collected - Volc{\'a}n de Colima block and ash flow}
