...
\section{QoIs and Data Collected}\label{sec:QoIs}
\subsection{Flow down an inclined plane, and a change in slope to a flat plane}\label{subsec:Ramp-QoIs}
...
\subsection{Volc{\'a}n de Colima block and ash flow}\label{subsec:Colima-QoIs}
\begin{itemize}
...
\vskip.3cm\noindent \textbf{PF} - $\phi_2 \in [10^{\mathrm{\circ}}, 30^{\mathrm{\circ}}]$, $\quad\Delta\phi_{12} \in [5^{\mathrm{\circ}}, 15^{\mathrm{\circ}}]$, $\quad\beta \in [0.1, 0.85]$, $\quad \mathcal{L}=10^{-1} \ (m)$, $\quad \phi_3=\phi_1 + 1^{\mathrm{\circ}}$.
...
\begin{figure}[H]
        \begin{minipage}[b]{.33\linewidth}        
                \centering
                \includegraphics[width=1\textwidth]{Boundaries/MC_VmaxFmin.jpg}
                \subcaption{\textbf{MC}: $\phi_{\mathrm{bed}}=10^{\mathrm{\circ}}$, $\phi_{\mathrm{int}}=12^{\mathrm{\circ}}$}\label{subfig:MaxVMinF-MC}
        \end{minipage}
        \begin{minipage}[b]{.33\linewidth}        
                \centering
                \includegraphics[width=1\textwidth]{Boundaries/PF_VmaxFmin.jpg}
                \subcaption{\textbf{PF}: $\phi_1=10^{\mathrm{\circ}}$, $\phi_2=25^{\mathrm{\circ}}$, $\beta=0.85$}\label{subfig:MaxVMinF-PF}
        \end{minipage}
        \begin{minipage}[b]{.33\linewidth}        
                \centering
                \includegraphics[width=1\textwidth]{Boundaries/VS_VmaxFmin.jpg}
                \subcaption{\textbf{VS}: $\mu=0.15$, $\xi=10^4 \ (m/s^2)$}\label{subfig:MaxVMinF-VS}
        \end{minipage}
        
        \begin{minipage}[b]{.33\linewidth}
                \centering
                \includegraphics[width=1\textwidth]{Boundaries/MC_VminFmax.jpg}
                \subcaption{\textbf{MC}: $\phi_{\mathrm{bed}}=25^{\mathrm{\circ}}$, $\phi_{\mathrm{int}}=35^{\mathrm{\circ}}$}\label{subfig:MinVMaxF-MC}
        \end{minipage}      
        \begin{minipage}[b]{.33\linewidth}
                \centering
                \includegraphics[width=1\textwidth]{Boundaries/PF_VminFmax.jpg}
                \subcaption{\textbf{PF}:  $\phi_1=20^{\mathrm{\circ}}$, $\phi_2=35^{\mathrm{\circ}}$, $\beta=0.1$}\label{subfig:MinVMaxF-PF}
        \end{minipage}      
        \begin{minipage}[b]{.33\linewidth}
                \centering
                \includegraphics[width=1\textwidth]{Boundaries/VS_VminFmax.jpg}
                \subcaption{\textbf{VS}:  $\mu=0.45$, $\xi=50 \ (m/s^2)$}\label{subfig:MinVMaxF-VS}
        \end{minipage}
        \caption{Comparison between \emph{Max Flow Height Record} maps of simulated flow exteremes with \emph{\textbf{max volume -- min resistence}} (\ref{subfig:MaxVMinF-MC}, \ref{subfig:MaxVMinF-PF} and \ref{subfig:MaxVMinF-VS}) and \emph{\textbf{min volume -- max resistence}} (\ref{subfig:MinVMaxF-MC}, \ref{subfig:MinVMaxF-PF} and \ref{subfig:MinVMaxF-VS}) with respect to each rheology model. Yellow solid lines indicate contoure of $h=5.0 \ cm$. Maximum and minimum material volumes are reported in Table (\ref{tab:Colima-Volume}).}
